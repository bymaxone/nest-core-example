...
/**
 * Provides the demo indicator state and the flaky and hanging indicators. The
 * event-loop indicator is stateless and bound directly by the core wiring
 * module, so it is not declared here.
 */
@Module({
