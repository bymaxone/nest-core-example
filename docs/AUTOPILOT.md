...
- **Project root**: the repository checkout (this file lives at `docs/AUTOPILOT.md` within it); every command below runs from that root
- **GitHub repo**: bymaxone/nest-core-example (visibility: private today, will be made public)
- **Default branch**: main
...
The library lives in the sibling checkout `../nest-core` (relative to this repo root) and is
